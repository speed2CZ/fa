...
ObjectiveGroup = ClassSimple {
    ...
    ---@protected
    __init = function(self, name, callback, numRequired)
        if not name then
    ...
    ---@protected
    OnObjectiveResult = function(self, objective, result, data)
    ...
    ---@param self ObjectiveGroup
    ---@param objective Objective
    AddObjective = function(self, objective)
        self:CheckActive()
    ...
    ---@param self ObjectiveGroup
    ---@param objective Objective
    RemoveObjective = function(self, objective)
