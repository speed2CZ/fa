...
---@field ShowProgress boolean|nil Defaults to `true` to show the progress in the UI.
---@field Timer integer|nil Time in seconds after which the objective will end. Set `ExpireResult` to complete of fail the objective.
---@field ExpireResult ObjectiveExpireResult|nil Requires `Timer` to be set.
...
---@field Areas string[]|nil
---@field MarkArea boolean|nil
---@field MarkUnits boolean|nil
---@field FlashVisible boolean|nil
---@field AlwaysVisible boolean|nil
---@field PercentProgress boolean|nil Show the progress in UI in percent. Defaults to false.
---@field Unit Unit|nil
---@field Units Unit[]|nil
---@field Hidden boolean|nil Objective will not be displayed in the UI.
---@field ShowFaction ObjectiveFactionIcon|nil Faction icon will be used as the objective icon.
---@field Category EntityCategory|nil
---@field NumRequired integer|nil Specific amount required, if not provided it can be calculated from provided `Units`. `PercentRequired` can be used as well.
---@field PercentRequired number|nil Alternative to `NumRequired`
---@field Requirements ObjectiveTargetRequirements|nil
...
---@field Timer integer Time in seconds to indicate how long you need to protect the units
---@field ExpireResult "complete" | "failed" | nil How should the objective end when the timer expires. Defaults to "failed"
---@field ShowProgress boolean Flag to update the description of the objective in the UI

--- Adds a timer objective that either complates or fails when the time runs out
---@param Type ObjectiveType          # Type of objective, used for the strategic icon in the UI
---@param Complete ObjectiveStatus    # Completion status, usually this is 'incomplete' unless the player already completed it by chance
---@param Title string                # Title of the objective, supports strings with LOC
---@param Description string          # Description of the objective, supports strings with LOC
